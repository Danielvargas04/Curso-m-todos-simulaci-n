...
const int N=Nx*Ny;
const double g=9.8;
const double KHertz=1.0e4, Gamma=150;
...
private:
public:
  void CalculeTodasLasFuerzas(Cuerpo * Granos);
...
void Colisionador::CalculeFuerzaEntre(Cuerpo & Grano1,Cuerpo & Grano2){
  ...
  if(s>0){ //Si hay colisión
    ...
    //Calculo y sumo la fuerza de deformacion plastica normal
